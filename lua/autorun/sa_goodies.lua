...
SA.Goodies = {
	ally_1m = {
		...
		func = function(ply)
			ply.SAData.alliance_membership_expiry = math.max(ply.SAData.alliance_membership_expiry, os.time()) + (2592000 * 1)
	...
	ally_3m = {
		...
		image = "SA_Research_Icon",
		func = function(ply)
			ply.SAData.alliance_membership_expiry = math.max(ply.SAData.alliance_membership_expiry, os.time()) + (2592000 * 3)
			ply:AssignFaction("alliance")
		end
	},
	ally_6m = {
		...
		image = "SA_Research_Icon",
		func = function(ply)
			ply.SAData.alliance_membership_expiry = math.max(ply.SAData.alliance_membership_expiry, os.time()) + (2592000 * 6)
			ply:AssignFaction("alliance")
		end
	},
	ally_12m = {
		...
		image = "SA_Research_Icon",
		func = function(ply)
			ply.SAData.alliance_membership_expiry = math.max(ply.SAData.alliance_membership_expiry, os.time()) + (2592000 * 12)
			ply:AssignFaction("alliance")
		end
	},
	vip = {
