...
function ENT:CalcVars(ply)
	...
	if ((reqLvl == nil) or (ply.SAData.research.ice_product_storage_level[1] < reqLvl)) then self:Remove() return end

	local Capacity = math.floor(30000 * (2.25 ^ reqLvl)) * ply.SAData.advancement_level
